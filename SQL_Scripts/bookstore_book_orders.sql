...
CREATE TABLE `book_orders` (
  `user_name` varchar(10) NOT NULL DEFAULT 'hazem',
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `book_orders_BEFORE_DELETE` BEFORE DELETE ON `book_orders` FOR EACH ROW BEGIN
UPDATE books SET books.no_copies = (books.no_copies + OLD.quantity) where books.ISBN = OLD.ISBN;
END */;;
DELIMITER ;
